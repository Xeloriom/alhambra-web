...
const ProjectCard = memo(({ project, index }: { project: Project; index: number }) => {
    ...
    return (
        <motion.div
            ...
            // ON ENLÈVE viewport={{ once: true }} ICI
            transition={{ duration: 1.2, delay: index * 0.1, ease: [0.16, 1, 0.3, 1] as any }}
        ...
        >
            <div className="relative aspect-[16/10] overflow-hidden rounded-[30px] bg-[#EEE] z-10">
                ...
                <div className="absolute bottom-10 left-10 z-20 flex items-center pointer-events-none">
                    <motion.div
                    ...
                    <div className="flex">
                        {titleLetters.map((letter: string, i: number) => (
                            <motion.span
                                ...
                                transition={{ type: "spring", stiffness: 350, damping: 12, delay: isHovered ? i * 0.03 : 0 }}
...
// ── COMPOSANT PRINCIPAL WORK SECTION ──
    ...
    return (
        <section className="w-full bg-[#F8F8F8] px-16 py-32 font-haas overflow-hidden" id="work">
            <motion.span
                ...
                // ON ENLÈVE viewport={{ once: true }} ICI AUSSI
                className="block text-black text-[32px] mb-12 font-bold tracking-tight"
            >
                Projets
            </motion.span>
            ...
            <div className="mb-24">
                <motion.h2
                    ...
                    initial="hidden"
                    whileInView="visible"
                    className="text-[3vw] leading-[1.1] text-black font-bold tracking-tighter flex flex-wrap"
                >
                    {words.map((word, i) => (
                ...
                <motion.h2
                    ...
                    whileInView="visible"
                    custom={1.2}
                    className="text-[3vw] leading-[1.1] text-black font-bold tracking-tighter flex flex-wrap mt-2 "
                >
                    {words2.map((word, i) => (
                        <motion.span variants={child as any} key={i} className="mr-[0.25em] inline-block">
                            {word}
