...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${BASE}/og-image.png`, width: 1200, height: 630, alt: 'Agence Web Lyon — Alhambra' }],
  },
}
  ...
  return (
    <>
      ...
      <main>
          ...
          subtitle="Nous créons des sites web et des expériences digitales qui transforment les visiteurs en clients. Stack Next.js dernière génération, design radical, performance garantie. Score Lighthouse 95+ sur chaque livraison."
