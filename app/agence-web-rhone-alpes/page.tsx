...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${BASE}/og-image.png`, width: 1200, height: 630, alt: 'Agence Web Rhône-Alpes — Alhambra' }],
  },
}
  ...
  return (
    <>
      ...
      <main>
          ...
          subtitle="Agence web pour toute la région Auvergne-Rhône-Alpes. Sites vitrines, e-commerce, applications web — livrés avec performance et design sur-mesure."
