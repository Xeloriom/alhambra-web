...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${BASE}/og-image.png`, width: 1200, height: 630, alt: 'Agence Web Ain — Alhambra' }],
  },
}
  ...
  return (
    <>
      ...
      <main>
          ...
          subtitle="Création de sites web sur-mesure pour les entreprises de l'Ain. Performance Lighthouse 95+, design premium, livrés en 2 à 4 semaines."
