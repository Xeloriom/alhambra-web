...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${BASE}/og-image.png`, width: 1200, height: 630, alt: 'Logiciel sur Mesure Lyon — Alhambra' }],
  },
}
  ...
  return (
    <>
      ...
      <main>
          ...
          eyebrow="Alhambra Web · Logiciel sur-mesure Lyon"
          title={<>
            Agence Logiciel<br />
          ...
          subtitle="Développement de logiciels et d'outils métier sur-mesure à Lyon. SaaS, ERP, tableaux de bord, automatisation. Stack moderne, livraison agile."
          ctaLabel="Devis gratuit 24h"
          stats={[
          { value: 'SaaS & ERP', label: 'Spécialités' },
          { value: '8–16 sem.', label: 'Livraison' },
          { value: 'Sur devis', label: 'Logiciel métier' },
          ]}
        />
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <Link
                    ...
                    className="px-4 py-[10px] rounded-full border border-black/10 hover:border-black/30 transition-colors text-black/60 hover:text-black"
                  >
                    {label}
                  </Link>
                ))}
            ...
            <div className="space-y-6">
              {FAQS.map((faq) => (
                ...
                >
                  ...
                  >
                    <h3 style={{ fontFamily: 'var(--font-haas)', fontWeight: 700, fontSize: 'clamp(13px,3.5vw,15px)' }}>{faq.q}</h3>
